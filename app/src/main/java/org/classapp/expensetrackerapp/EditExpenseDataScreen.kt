...
@Composable
fun EditExpenseDataScreen(navController: NavController)
{
    ExpenseTrackerAppTheme (dynamicColor = false) {
        ...
        {
            EditExpenseTopAppBar(navController)
        }
    }
}
...
@Composable
fun EditExpenseTopAppBar(navController: NavController)
{
            ...
            )
            {
                ...
                Column (
                    ...
                    Row {
                        OutlinedButton(
                            onClick = {
                                // TODO: Delete data from json later
                            ...
                            onClick = {
                                ...
                                updateTransactionData(context, currentInspectTransactionDataType,
                                    TransactionData(
                                        ...
                                        expenseType = getTransactionDataById(currentInspectTransactionDataType, currentInspectTransactionDataId).expenseType,
...
@Preview
@Composable
fun EditExpenseDataScreenPreview() {
    EditExpenseDataScreen(navController = rememberNavController())
}